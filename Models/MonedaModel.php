<?php
    ...
    class moneda extends conectar{
        ...
        public function get_unidad_id($mon_id){
            $conectar = parent::conexion();
            $sql = "SP_L_MONEDA_02 ?";
            $sql_query=$conectar->prepare($sql);
        ...
        public function delete_unidad($mon_id){
            $conectar = parent::conexion();
            $sql = "SP_D_MONEDA_01 ?";
            $sql_query=$conectar->prepare($sql);
            $sql_query->bindValue(1, $mon_id);
        ...
        public function insert_unidad($suc_id, $mon_name){
            $conectar = parent::conexion();
            $sql = "SP_I_MONEDA_01 ?,? ";
            $sql_query=$conectar->prepare($sql);
            $sql_query->bindValue(1, $suc_id);
        ...
        public function update_unidad($mon_id, $suc_id, $mon_name){
            $conectar = parent::conexion();
            $sql = "SP_U_MONEDA_01 ?,?,?";
            $sql_query=$conectar->prepare($sql);
            $sql_query->bindValue(1, $mon_id);
