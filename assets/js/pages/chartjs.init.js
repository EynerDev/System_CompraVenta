...
lineChartColor = getChartColorsArray("lineChart"), lineChartColor && (islinechart.setAttribute("width", islinechart.parentElement.offsetWidth), lineChart = new Chart(islinechart, {
    type: "line",
    data: {
...
pieChartColors = getChartColorsArray("pieChart"), pieChartColors && (pieChart = new Chart(ispiechart, {
    type: "pie",
    data: {
...
polarAreaChartColors = getChartColorsArray("polarArea"), polarAreaChartColors && (lineChart = new Chart(ispolarAreachart, {
    type: "polarArea",
    data: {
...
var lineChart, isradarchart = document.getElementById("radar");
radarChartColors = getChartColorsArray("radar"), radarChartColors && (lineChart = new Chart(isradarchart, {
    type: "radar",
    data: {
