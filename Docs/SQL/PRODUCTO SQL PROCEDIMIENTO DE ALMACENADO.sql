...
CREATE PROCEDURE SP_L_TOP_PRODUCTOS_01
@SUC_ID INT 
AS
BEGIN
	...
	TM_PRODUCTO.PROD_NAME, TM_CATEGORIA.CAT_NAME, 
	TM_UNIDAD_DE_MEDIDA.UNID_NAME, 
	...
	FROM     TD_COMPRA_DETALLE INNER JOIN
					  ...
					  TM_UNIDAD_DE_MEDIDA ON TM_PRODUCTO.UNID_ID = TM_UNIDAD_DE_MEDIDA.UNI_ID INNER JOIN
	...
	WHERE TM_COMPRA.ACTIVE = 1 AND
	TM_PRODUCTO.ACTIVE = 1 AND 
	TM_COMPRA.SUC_ID = @SUC_ID
	GROUP BY TD_COMPRA_DETALLE.PROD_ID, TM_PRODUCTO.PROD_NAME, TM_CATEGORIA.CAT_NAME, TM_UNIDAD_DE_MEDIDA.UNID_NAME, TM_PRODUCTO.PROD_PCOMPRA, TM_PRODUCTO.PROD_STOCK, 
					  TM_PRODUCTO.PROD_IMG
	ORDER BY CANT DESC
END