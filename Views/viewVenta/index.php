                                            ...
                                            <div class="card-body p-4">
                                                <div class="row g-3">
                                                    <div class="col-lg-3 col-6">
                                                        ...
                                                        <h5 class="fs-14 mb-0">#C-<span id="venta_id"></span></h5>
                                                    </div>
                                                    ...
                                                    <p class="fw-medium mb-2" id="mon_name"></p>
                                                    </div>
                                                    
                                                    <div class="col-lg-3 col-6">
                                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Total</p>
                                                        <h5 class="fs-14 mb-0">$<span id="venta_total"></span></h5>
                                                    </div>
                                        ...
                                        <div class="card-body p-4 border-top border-top-dashed">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <p class="fw-medium mb-2"id=""><span>Nombre: </span><span id="cli_name"></span></p>
                                                    <p class="fw-medium mb-2"><span>Dirección: </span><span id="cli_dirc"></span></p>
                                                    <p class="fw-medium mb-2"><span>Numero: </span><span id="cli_number"></span></p>
                                                    <p class="fw-medium mb-2"><span>Email: </span><span id="cli_email"></span></p>
