$(document).ready(function() {
    ...
    .done(function(data) {
        ...
        $("#compra_total").html(datos.COMPRA_TOTAL)
        $("#created_at").html(datos.CREATED_AT)
        $("#sub_total").html(datos.COMPRA_SUB_TOTAL)
        $("#compra_iva").html(datos.COMPRA_IVA)
        $("#compra_total2").html(datos.COMPRA_TOTAL)
